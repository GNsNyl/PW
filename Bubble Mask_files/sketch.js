...
/* - - Preload - - */
function preload() {
  bgImg0 = loadImage("dist/img_port/tactile.png"); // layer 0 (background image)
  bgImg1 = loadImage("dist/img_port/logo.png"); // layer 1 (logo)
  bgImg2 = loadImage("dist/img_digit/c1.gif"); // layer 2 (image)
  bgImg3 = loadImage("dist/img_port/india/india.png"); // layer 3 (image)
}
